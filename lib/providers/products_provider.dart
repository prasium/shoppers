...
//     ),
  ...
  Future<void> addProduct(Product product) async {
    //_items.add(value);
    final url = Uri.parse(
        'https://shoppers-c54d9-default-rtdb.firebaseio.com/products.json?auth=$authToken');
    try {
  ...
  Future<void> updateProduct(String id, Product newProduct) async {
    ...
    if (prodIndex >= 0) {
      final url = Uri.parse(
          'https://shoppers-c54d9-default-rtdb.firebaseio.com/products/$id.json?auth=$authToken');
  ...
  final filterString = filterByUser? 'orderBy="creatorId"&equalTo="$userId"':'';
    var url = Uri.parse(
        'https://shoppers-c54d9-default-rtdb.firebaseio.com/products.json?auth=$authToken&$filterString');
    try {
      ...
      url = Uri.parse(
          'https://shoppers-c54d9-default-rtdb.firebaseio.com/userFavorites/$userId.json?auth=$authToken');
